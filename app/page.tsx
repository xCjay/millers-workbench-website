...
export default function MillersWorkbenchLanding() {
  const services = [
    ...
    },
    {
      ...
      description: "Outlets, switches, and lighting that actually work the way they should.",
      examples: "New outlets, fixture installation, switch repairs",
    },
    {
      ...
      <header className="bg-gradient-to-r from-amber-900 to-orange-900 shadow-lg sticky top-0 z-50">
        <div className="container mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            ...
            <Button className="bg-amber-600 hover:bg-amber-500 text-white shadow-lg font-semibold">
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <p className="text-xl text-amber-800 mb-10 leading-relaxed font-medium">
                You know those little projects that have been bugging you for months? The ones that are "too small" for
              ...
              <div className="flex flex-col sm:flex-row gap-6">
                <Button
                  size="lg"
                  className="bg-gradient-to-r from-amber-600 to-orange-600 hover:from-amber-700 hover:to-orange-700 text-white shadow-xl font-semibold text-lg px-8 py-4"
                >
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div>
              ...
              <p className="text-lg text-amber-800 mb-8 leading-relaxed">
                ...
                someone who cares about the details.{" "}
                <strong className="text-amber-900 font-bold">"We do the work that big contractors won't touch"</strong>{" "}
                - and we do it with the same care and professionalism you'd expect from any major project.
              </p>
              <div className="grid grid-cols-2 gap-6">
                ...
                <div className="text-center bg-gradient-to-br from-amber-100 to-orange-100 p-6 rounded-2xl shadow-lg border border-amber-200">
                  ...
                  <div className="text-amber-800 font-semibold">Happy Neighbors</div>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-12">
            ...
            <div>
              ...
              <div className="space-y-4">
                <p className="text-amber-200 flex items-center font-medium">
                  <Phone className="h-5 w-5 mr-3" />
                  (801) 494-9558
                </p>
                <p className="text-amber-200 flex items-center font-medium">
